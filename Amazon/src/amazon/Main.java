...
public class Main {
	...
	public static void showMenu() {
		...
		do {
			...
			int response = Amazon.validateUserResponseMenu(0, 6);
	...
	public static void showMovies() {
		...
		do {
			...
			int response = Amazon.validateUserResponseMenu(0, movies.size());
	...
	public static void showSeries() {
		...
		do {
			...
			//Leer Respuesta usuario
			int response = Amazon.validateUserResponseMenu(0, series.size());
	...
	public static void showChapters(ArrayList<Chapter> chaptersOfSerieSelected) {
		...
		do {
			...
			//Leer Respuesta usuario
			int response = Amazon.validateUserResponseMenu(0, chaptersOfSerieSelected.size());
	...
	public static void showBooks() {
		...
		do {
			...
			//Leer Respuesta usuario
			int response = Amazon.validateUserResponseMenu(0, books.size());
	...
	public static void showMagazines() {
		...
		do {
			...
			//Leer Respuesta usuario
			int response = Amazon.validateUserResponseMenu(0, 0);
